...
with a one-line note rather than composing an export that cannot build (OPEN-QUANT-Q8). The
other three sizes keep their container's q8 role. The q4_1 path is unaffected and still passes: the shipped
