...
Prefill time-to-first-token (TTFT) for Qwen3-VL-4B on NPU (OpenFlowLM) with different image resolutions.

**Mid Resolution Images:**

| Model        | HW  | 720p (1280×720) | 1080p (1920×1080) | 
|--------------|-----------|----------------:|------------------:|
| Qwen3-VL-4B  | NPU (OFLM) |            3.3 |               7.4 |
...
|--------------|-----------|---------------:|---------------:|
| Qwen3-VL-4B  | NPU (OFLM) |           13.7 |             41.2 |
